/**
 * My Feedbacks Page
 * View all feedbacks submitted by the current user
 */
...
import { MessageSquare, Bug, Sparkles, Lightbulb, HelpCircle, Star, CheckCircle, XCircle, Clock, Trash2 } from 'lucide-react'
...
interface FeedbackWithResponse extends Feedback {
  responded_by_user?: {
    id: string
    email: string
    name: string | null
...
export default function MyFeedbacksPage() {
  ...
  const [feedbacks, setFeedbacks] = useState<FeedbackWithResponse[]>([])
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">{t('myFeedbacksDescription')}</p>
        </div>
      </div>
